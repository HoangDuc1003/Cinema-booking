...
<USER_REQUEST>
You are Reviewer 7 evaluating Milestone 4: Native Video State Machine & Retry Lifecycle (R5).
Working directory for metadata: e:\NitroCine\.agents\reviewer_7
...
5. Provide your verdict (PASS / FAIL with rationale) and write a self-contained report to `e:\NitroCine\.agents\reviewer_7\handoff.md`.
